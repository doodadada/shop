					...
					<h2>주문자 정보</h2>
						<div class="tb">
							...
							<div class="row">
								...
								<div class="col">${orderDetail.zip_num} ${orderDetail.address1} ${orderDetail.address2}</div>
							</div>
						</div>
						...
						<div class="tb">
							...
							<c:forEach items="${orderList}" var="orderVO">
									<div class="row">
										...
										<div class="col"><fmt:formatNumber type="currency" value="${orderVO.price2*orderVO.quantity}"></fmt:formatNumber></div>
									</div>
							</c:forEach>
						</div>
