		...
		<div class="tb">
			<div class="row">
				<div class="col" style="display: flex; align-items:center;">
					주문상품명 &nbsp; <input type="text" name="key" value="${key}" /> &nbsp;
					&nbsp; &nbsp; <input class="btn" type="button" name="btn_search"
						value="검색" onClick="go_search('adminOrderList')" />
					&nbsp;&nbsp;&nbsp; 
				</div>
			</div>
			<div class="row">
				...
				<!-- <div class="coltitle"style="flex:2;">전화</div> -->
			...
			<c:forEach items="${orderList}" var="orderVO">
				<div class="row">
					...
					<div class="col" style="fl	ex:1;">${orderVO.pname}</div>
					...
					<div class="col" style="flex:2;"><fmt:formatDate type="date" value="${orderVO.indate}" /></div>
				</div>
			</c:forEach>
			<div class="row">
				<div class="col">
			...
			<div class="btn">
				<input type="button" class="btn" style="width:200px" value="처리완료" onClick="go_order_save()">
			</div>
		</div>
	</form>
</article>
